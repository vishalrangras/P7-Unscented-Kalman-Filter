 ...
 ******************************************************************************/
  ...
  //std::cout << "P_aug after topLeftCorner filled with P = " << std::endl << P_aug << std::endl;
 ...
 ******************************************************************************/
  ...
  //std::cout << "Computed Weights" << std::endl << weights << std::endl;

  //predicted state mean
  x.fill(0.0);
  for (int i = 0; i < 2 * n_aug + 1; i++) {  //iterate over sigma points
    x = x+ weights(i) * Xsig_pred.col(i);
    //std::cout << "Value of x for loop "<< i <<" is:" << std::endl << x << std::endl;
    ...
    //std::cout << "weights(i) * Xsig_pred.col(i)"<< weights(i) * Xsig_pred.col(i) << std::endl;
  }
  
  //std::cout << "Value of x is: " << std::endl << x << std::endl;
